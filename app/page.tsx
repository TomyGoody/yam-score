...
function StartScreen({
  ...
  const router = useRouter();
  return (
  <section className="relative flex h-full items-center justify-center overflow-hidden bg-black px-4 text-white">
    <AuthButton />
...
function VictoryModal({
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 px-4">
    <div className="w-full max-w-xl rounded-3xl border border-[#9B6A28]/70 bg-black p-8 text-center shadow-2xl">
      ...
      <div className="mt-2 text-7xl font-black text-[#F4E9DC]">
        {winner.total}
      </div>
      ...
      <div className="my-7 h-px bg-[#9B6A28]/40" />
      ...
      <div className="grid gap-2">
        {players.map((player) => (
          <div
            key={player.id}
            className={[
              "flex items-center justify-between rounded-xl px-4 py-3 font-black",
              player.rank === 1
                ? "bg-[#C44934] text-white"
      ...
      {runnerUp && (
        <div className="mt-4 text-lg font-black text-[#C44934]">
